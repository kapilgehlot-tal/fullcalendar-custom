...
//   ../../../../../fullcalendar-custom/daygrid

declare module 'fullcalendar-custom/timegrid' {
    import AbstractTimeGridView from 'fullcalendar-custom/timegrid/AbstractTimeGridView';
    import TimeGridView, { buildDayTable } from 'fullcalendar-custom/timegrid/TimeGridView';
    import { TimeGridSeg } from 'fullcalendar-custom/timegrid/TimeGrid';
    import { TimeGridSlicer, buildDayRanges } from 'fullcalendar-custom/timegrid/SimpleTimeGrid';
    export { TimeGridView, AbstractTimeGridView, buildDayTable, buildDayRanges, TimeGridSlicer, TimeGridSeg };
    export { default as TimeGrid } from 'fullcalendar-custom/timegrid/TimeGrid';
    const _default: import("fullcalendar-custom/core").PluginDef;
    export default _default;
}

declare module 'fullcalendar-custom/timegrid/AbstractTimeGridView' {
    import { ScrollComponent, View, ComponentContext, Duration, ViewProps } from 'fullcalendar-custom/core';
    import { DayGrid } from 'fullcalendar-custom/daygrid';
    import TimeGrid from 'fullcalendar-custom/timegrid/TimeGrid';
    import AllDaySplitter from 'fullcalendar-custom/timegrid/AllDaySplitter';
...
declare module 'fullcalendar-custom/timegrid/TimeGridView' {
    import { DateProfileGenerator, DateProfile, ComponentContext, DayHeader, DayTable, ViewProps } from 'fullcalendar-custom/core';
    import { SimpleDayGrid } from 'fullcalendar-custom/daygrid';
    import SimpleTimeGrid from 'fullcalendar-custom/timegrid/SimpleTimeGrid';
    import AbstractTimeGridView from 'fullcalendar-custom/timegrid/AbstractTimeGridView';
...
declare module 'fullcalendar-custom/timegrid/TimeGrid' {
    import { PositionCache, Duration, DateMarker, DateFormatter, ComponentContext, DateComponent, Seg, EventSegUiInteractionState, DateProfile, Theme } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/timegrid/SimpleTimeGrid' {
    import { DateComponent, DateProfile, EventStore, EventUiHash, EventInteractionState, DateSpan, DateRange, DayTable, DateEnv, DateMarker, Slicer, Hit, ComponentContext } from 'fullcalendar-custom/core';
    import TimeGrid, { TimeGridSeg } from 'fullcalendar-custom/timegrid/TimeGrid';
...
declare module 'fullcalendar-custom/timegrid/AllDaySplitter' {
    import { Splitter, EventDef, DateSpan } from 'fullcalendar-custom/core';
