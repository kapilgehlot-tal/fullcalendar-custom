...
//   ../../../../../fullcalendar-custom/core

declare module 'fullcalendar-custom/core' {
    export const version = "<%= version %>";
    export { OptionsInput } from 'fullcalendar-custom/core/types/input-types';
    export { EventInput, EventDef, EventDefHash, EventInstance, EventInstanceHash, parseEventDef, createEventInstance, EventTuple } from 'fullcalendar-custom/core/structs/event';
    export { BusinessHoursInput, parseBusinessHours } from 'fullcalendar-custom/core/structs/business-hours';
    export { applyAll, debounce, padStart, isInt, capitaliseFirstLetter, parseFieldSpecs, compareByFieldSpecs, compareByFieldSpec, flexibleCompare, computeVisibleDayRange, refineProps, matchCellWidths, uncompensateScroll, compensateScroll, subtractInnerElHeight, isMultiDayRange, distributeHeight, undistributeHeight, preventSelection, allowSelection, preventContextMenu, allowContextMenu, compareNumbers, enableCursor, disableCursor, diffDates } from 'fullcalendar-custom/core/util/misc';
    export { htmlEscape, cssToStr } from 'fullcalendar-custom/core/util/html';
    export { removeExact, isArraysEqual } from 'fullcalendar-custom/core/util/array';
    export { memoize, memoizeOutput } from 'fullcalendar-custom/core/util/memoize';
    export { memoizeRendering, MemoizedRendering } from 'fullcalendar-custom/core/component/memoized-rendering';
    export { intersectRects, Rect, pointInsideRect, constrainPoint, getRectCenter, diffPoints, Point, translateRect } from 'fullcalendar-custom/core/util/geom';
    export { mapHash, filterHash, isPropsEqual } from 'fullcalendar-custom/core/util/object';
    export { findElements, findChildren, htmlToElement, createElement, insertAfterElement, prependToElement, removeElement, appendToElement, applyStyle, applyStyleProp, elementMatches, elementClosest, forceClassName } from 'fullcalendar-custom/core/util/dom-manip';
    export { EventStore, filterEventStoreDefs, createEmptyEventStore, mergeEventStores, getRelevantEvents, eventTupleToStore } from 'fullcalendar-custom/core/structs/event-store';
    export { EventUiHash, EventUi, processScopedUiProps, combineEventUis } from 'fullcalendar-custom/core/component/event-ui';
    export { default as Splitter, SplittableProps } from 'fullcalendar-custom/core/component/event-splitting';
    export { buildGotoAnchorHtml, getAllDayHtml, getDayClasses } from 'fullcalendar-custom/core/component/date-rendering';
    export { preventDefault, listenBySelector, whenTransitionDone } from 'fullcalendar-custom/core/util/dom-event';
    export { computeInnerRect, computeEdges, computeHeightAndMargins, getClippingParents, computeClippingRect, computeRect } from 'fullcalendar-custom/core/util/dom-geom';
    export { unpromisify } from 'fullcalendar-custom/core/util/promise';
    export { default as EmitterMixin, EmitterInterface } from 'fullcalendar-custom/core/common/EmitterMixin';
    export { DateRange, rangeContainsMarker, intersectRanges, rangesEqual, rangesIntersect, rangeContainsRange } from 'fullcalendar-custom/core/datelib/date-range';
    export { default as Mixin } from 'fullcalendar-custom/core/common/Mixin';
    export { default as PositionCache } from 'fullcalendar-custom/core/common/PositionCache';
    export { default as ScrollComponent, ScrollbarWidths } from 'fullcalendar-custom/core/common/ScrollComponent';
    export { ScrollController, ElementScrollController, WindowScrollController } from 'fullcalendar-custom/core/common/scroll-controller';
    export { default as Theme } from 'fullcalendar-custom/core/theme/Theme';
    export { default as Component, ComponentContext } from 'fullcalendar-custom/core/component/Component';
    export { default as DateComponent, Seg, EventSegUiInteractionState } from 'fullcalendar-custom/core/component/DateComponent';
    export { default as Calendar, DatePointTransform, DateSpanTransform, DateSelectionApi } from 'fullcalendar-custom/core/Calendar';
    export { default as View, ViewProps } from 'fullcalendar-custom/core/View';
    export { default as FgEventRenderer, buildSegCompareObj } from 'fullcalendar-custom/core/component/renderers/FgEventRenderer';
    export { default as FillRenderer } from 'fullcalendar-custom/core/component/renderers/FillRenderer';
    export { default as DateProfileGenerator, DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    export { ViewDef } from 'fullcalendar-custom/core/structs/view-def';
    export { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
    export { DateSpan, DateSpanApi, DatePointApi, isDateSpansEqual } from 'fullcalendar-custom/core/structs/date-span';
    export { DateMarker, addDays, startOfDay, addMs, addWeeks, diffWeeks, diffWholeWeeks, diffWholeDays, diffDayAndTime, diffDays, isValidDate } from 'fullcalendar-custom/core/datelib/marker';
    export { Duration, createDuration, isSingleDay, multiplyDuration, addDurations, asRoughMinutes, asRoughSeconds, asRoughMs, wholeDivideDurations, greatestDurationDenominator } from 'fullcalendar-custom/core/datelib/duration';
    export { DateEnv, DateMarkerMeta } from 'fullcalendar-custom/core/datelib/env';
    export { DateFormatter, createFormatter, VerboseFormattingArg, formatIsoTimeString } from 'fullcalendar-custom/core/datelib/formatting';
    export { NamedTimeZoneImpl } from 'fullcalendar-custom/core/datelib/timezone';
    export { parse as parseMarker } from 'fullcalendar-custom/core/datelib/parsing';
    export { EventSourceDef, EventSource, EventSourceHash } from 'fullcalendar-custom/core/structs/event-source';
    export { Interaction, InteractionSettings, interactionSettingsToStore, interactionSettingsStore, InteractionSettingsStore } from 'fullcalendar-custom/core/interactions/interaction';
    export { PointerDragEvent } from 'fullcalendar-custom/core/interactions/pointer';
    export { Hit } from 'fullcalendar-custom/core/interactions/hit';
    export { dateSelectionJoinTransformer } from 'fullcalendar-custom/core/interactions/date-selecting';
    export { eventDragMutationMassager, EventDropTransformers } from 'fullcalendar-custom/core/interactions/event-dragging';
    export { EventResizeJoinTransforms } from 'fullcalendar-custom/core/interactions/event-resizing';
    export { default as ElementDragging } from 'fullcalendar-custom/core/interactions/ElementDragging';
    export { formatDate, formatRange } from 'fullcalendar-custom/core/formatting-api';
    export { globalDefaults, config } from 'fullcalendar-custom/core/options';
    export { RecurringType, ParsedRecurring } from 'fullcalendar-custom/core/structs/recurring-event';
    export { DragMetaInput, DragMeta, parseDragMeta } from 'fullcalendar-custom/core/structs/drag-meta';
    export { createPlugin, PluginDef, PluginDefInput, ViewPropsTransformer, ViewContainerModifier } from 'fullcalendar-custom/core/plugin-system';
    export { reducerFunc, Action, CalendarState } from 'fullcalendar-custom/core/reducers/types';
    export { CalendarComponentProps } from 'fullcalendar-custom/core/CalendarComponent';
    export { default as DayHeader } from 'fullcalendar-custom/core/common/DayHeader';
    export { computeFallbackHeaderFormat, renderDateCell } from 'fullcalendar-custom/core/common/table-utils';
    export { default as DaySeries } from 'fullcalendar-custom/core/common/DaySeries';
    export { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    export { EventRenderRange, sliceEventStore, hasBgRendering, getElSeg, computeEventDraggable, computeEventStartResizable, computeEventEndResizable } from 'fullcalendar-custom/core/component/event-rendering';
    export { default as DayTable, DayTableSeg, DayTableCell } from 'fullcalendar-custom/core/common/DayTable';
    export { default as Slicer, SlicedProps } from 'fullcalendar-custom/core/common/slicing-utils';
    export { EventMutation, applyMutationToEventStore } from 'fullcalendar-custom/core/structs/event-mutation';
    export { Constraint, ConstraintInput, AllowFunc, isPropsValid, isInteractionValid } from 'fullcalendar-custom/core/validation';
    export { default as EventApi } from 'fullcalendar-custom/core/api/EventApi';
    export { default as requestJson } from 'fullcalendar-custom/core/util/requestJson';
}

declare module 'fullcalendar-custom/core/types/input-types' {
    import View from 'fullcalendar-custom/core/View';
    import { EventSourceInput, EventInputTransformer } from 'fullcalendar-custom/core/structs/event-source';
    import { Duration, DurationInput } from 'fullcalendar-custom/core/datelib/duration';
    import { DateInput } from 'fullcalendar-custom/core/datelib/env';
    import { FormatterInput } from 'fullcalendar-custom/core/datelib/formatting';
    import { DateRangeInput } from 'fullcalendar-custom/core/datelib/date-range';
    import { BusinessHoursInput } from 'fullcalendar-custom/core/structs/business-hours';
    import EventApi from 'fullcalendar-custom/core/api/EventApi';
    import { AllowFunc, ConstraintInput, OverlapFunc } from 'fullcalendar-custom/core/validation';
    import { PluginDef } from 'fullcalendar-custom/core/plugin-system';
    import { LocaleSingularArg, RawLocale } from 'fullcalendar-custom/core/datelib/locale';
...
declare module 'fullcalendar-custom/core/structs/event' {
    import { DateInput } from 'fullcalendar-custom/core/datelib/env';
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { UnscopedEventUiInput, EventUi } from 'fullcalendar-custom/core/component/event-ui';
...
declare module 'fullcalendar-custom/core/structs/business-hours' {
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { EventInput } from 'fullcalendar-custom/core/structs/event';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
...
declare module 'fullcalendar-custom/core/util/misc' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { DateEnv } from 'fullcalendar-custom/core/datelib/env';
    import { DateRange, OpenDateRange } from 'fullcalendar-custom/core/datelib/date-range';
...
declare module 'fullcalendar-custom/core/util/html' {
...
declare module 'fullcalendar-custom/core/util/array' {
...
declare module 'fullcalendar-custom/core/util/memoize' {
...
declare module 'fullcalendar-custom/core/component/memoized-rendering' {
...
declare module 'fullcalendar-custom/core/util/geom' {
...
declare module 'fullcalendar-custom/core/util/object' {
...
declare module 'fullcalendar-custom/core/util/dom-manip' {
...
declare module 'fullcalendar-custom/core/structs/event-store' {
    import { EventInput, EventDef, EventDefHash, EventInstanceHash, EventTuple } from 'fullcalendar-custom/core/structs/event';
    import { EventSource } from 'fullcalendar-custom/core/structs/event-source';
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
...
declare module 'fullcalendar-custom/core/component/event-ui' {
    import { Constraint, AllowFunc, ConstraintInput } from 'fullcalendar-custom/core/validation';
    import { parseClassName } from 'fullcalendar-custom/core/util/html';
    import Calendar from 'fullcalendar-custom/core/Calendar';
...
declare module 'fullcalendar-custom/core/component/event-splitting' {
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventDef } from 'fullcalendar-custom/core/structs/event';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    import { EventUiHash, EventUi } from 'fullcalendar-custom/core/component/event-ui';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
...
declare module 'fullcalendar-custom/core/component/date-rendering' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
    import { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import { DateEnv } from 'fullcalendar-custom/core/datelib/env';
...
declare module 'fullcalendar-custom/core/util/dom-event' {
...
declare module 'fullcalendar-custom/core/util/dom-geom' {
    import { Rect } from 'fullcalendar-custom/core/util/geom';
...
declare module 'fullcalendar-custom/core/util/promise' {
    export function unpromisify(func: any, success: any, failure?: any): void;
}

declare module 'fullcalendar-custom/core/common/EmitterMixin' {
    import Mixin from 'fullcalendar-custom/core/common/Mixin';
...
declare module 'fullcalendar-custom/core/datelib/date-range' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { DateEnv, DateInput } from 'fullcalendar-custom/core/datelib/env';
...
declare module 'fullcalendar-custom/core/common/Mixin' {
...
declare module 'fullcalendar-custom/core/common/PositionCache' {
...
declare module 'fullcalendar-custom/core/common/ScrollComponent' {
    import { ElementScrollController } from 'fullcalendar-custom/core/common/scroll-controller';
...
declare module 'fullcalendar-custom/core/common/scroll-controller' {
...
declare module 'fullcalendar-custom/core/theme/Theme' {
...
declare module 'fullcalendar-custom/core/component/Component' {
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import View from 'fullcalendar-custom/core/View';
    import Theme from 'fullcalendar-custom/core/theme/Theme';
    import { DateEnv } from 'fullcalendar-custom/core/datelib/env';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
...
declare module 'fullcalendar-custom/core/component/DateComponent' {
    import Component from 'fullcalendar-custom/core/component/Component';
    import { EventRenderRange } from 'fullcalendar-custom/core/component/event-rendering';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { EventInstanceHash } from 'fullcalendar-custom/core/structs/event';
    import { Hit } from 'fullcalendar-custom/core/interactions/hit';
    import FgEventRenderer from 'fullcalendar-custom/core/component/renderers/FgEventRenderer';
    import FillRenderer from 'fullcalendar-custom/core/component/renderers/FillRenderer';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
...
declare module 'fullcalendar-custom/core/Calendar' {
    import { EmitterInterface } from 'fullcalendar-custom/core/common/EmitterMixin';
    import OptionsManager from 'fullcalendar-custom/core/OptionsManager';
    import View from 'fullcalendar-custom/core/View';
    import Theme from 'fullcalendar-custom/core/theme/Theme';
    import { OptionsInput, EventHandlerName, EventHandlerArgs } from 'fullcalendar-custom/core/types/input-types';
    import { RawLocaleMap } from 'fullcalendar-custom/core/datelib/locale';
    import { DateEnv, DateInput } from 'fullcalendar-custom/core/datelib/env';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { Duration, DurationInput } from 'fullcalendar-custom/core/datelib/duration';
    import { DateSpan, DateSpanApi, DatePointApi } from 'fullcalendar-custom/core/structs/date-span';
    import { DateRangeInput } from 'fullcalendar-custom/core/datelib/date-range';
    import DateProfileGenerator from 'fullcalendar-custom/core/DateProfileGenerator';
    import { EventSourceInput } from 'fullcalendar-custom/core/structs/event-source';
    import { EventInput } from 'fullcalendar-custom/core/structs/event';
    import { CalendarState, Action } from 'fullcalendar-custom/core/reducers/types';
    import EventSourceApi from 'fullcalendar-custom/core/api/EventSourceApi';
    import EventApi from 'fullcalendar-custom/core/api/EventApi';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventUiHash, EventUi } from 'fullcalendar-custom/core/component/event-ui';
    import { ViewSpecHash, ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
    import { PluginSystem } from 'fullcalendar-custom/core/plugin-system';
    import CalendarComponent from 'fullcalendar-custom/core/CalendarComponent';
    import DateComponent from 'fullcalendar-custom/core/component/DateComponent';
    import { PointerDragEvent } from 'fullcalendar-custom/core/interactions/pointer';
    import { InteractionSettingsInput, Interaction } from 'fullcalendar-custom/core/interactions/interaction';
...
declare module 'fullcalendar-custom/core/View' {
    import DateProfileGenerator, { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { EmitterInterface } from 'fullcalendar-custom/core/common/EmitterMixin';
    import { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
    import DateComponent from 'fullcalendar-custom/core/component/DateComponent';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventUiHash } from 'fullcalendar-custom/core/component/event-ui';
    import { EventRenderRange } from 'fullcalendar-custom/core/component/event-rendering';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
...
declare module 'fullcalendar-custom/core/component/renderers/FgEventRenderer' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { DateFormatter } from 'fullcalendar-custom/core/datelib/formatting';
    import { EventUi } from 'fullcalendar-custom/core/component/event-ui';
    import { EventRenderRange } from 'fullcalendar-custom/core/component/event-rendering';
    import { Seg } from 'fullcalendar-custom/core/component/DateComponent';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
...
declare module 'fullcalendar-custom/core/component/renderers/FillRenderer' {
    import { Seg } from 'fullcalendar-custom/core/component/DateComponent';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
...
declare module 'fullcalendar-custom/core/DateProfileGenerator' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { DateRange, OpenDateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
...
declare module 'fullcalendar-custom/core/structs/view-def' {
    import { ViewClass, ViewConfigHash } from 'fullcalendar-custom/core/structs/view-config';
...
declare module 'fullcalendar-custom/core/structs/view-spec' {
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import OptionsManager from 'fullcalendar-custom/core/OptionsManager';
    import { ViewConfigInputHash, ViewClass } from 'fullcalendar-custom/core/structs/view-config';
...
declare module 'fullcalendar-custom/core/structs/date-span' {
    import { DateRange, OpenDateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { DateInput, DateEnv } from 'fullcalendar-custom/core/datelib/env';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { EventRenderRange } from 'fullcalendar-custom/core/component/event-rendering';
    import { EventUiHash } from 'fullcalendar-custom/core/component/event-ui';
    import Calendar from 'fullcalendar-custom/core/Calendar';
...
declare module 'fullcalendar-custom/core/datelib/marker' {
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
...
declare module 'fullcalendar-custom/core/datelib/duration' {
...
declare module 'fullcalendar-custom/core/datelib/env' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { CalendarSystem } from 'fullcalendar-custom/core/datelib/calendar-system';
    import { Locale } from 'fullcalendar-custom/core/datelib/locale';
    import { NamedTimeZoneImpl, NamedTimeZoneImplClass } from 'fullcalendar-custom/core/datelib/timezone';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { DateFormatter } from 'fullcalendar-custom/core/datelib/formatting';
    import { CmdFormatterFunc } from 'fullcalendar-custom/core/datelib/formatting-cmd';
...
declare module 'fullcalendar-custom/core/datelib/formatting' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { CalendarSystem } from 'fullcalendar-custom/core/datelib/calendar-system';
    import { Locale } from 'fullcalendar-custom/core/datelib/locale';
    import { CmdFormatterFunc } from 'fullcalendar-custom/core/datelib/formatting-cmd';
    import { FuncFormatterFunc } from 'fullcalendar-custom/core/datelib/formatting-func';
...
declare module 'fullcalendar-custom/core/datelib/timezone' {
...
declare module 'fullcalendar-custom/core/datelib/parsing' {
...
declare module 'fullcalendar-custom/core/structs/event-source' {
    ...
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { EventSourceFunc } from 'fullcalendar-custom/core/event-sources/func-event-source';
    import { EventUi } from 'fullcalendar-custom/core/component/event-ui';
    import { ConstraintInput, AllowFunc } from 'fullcalendar-custom/core/validation';
...
declare module 'fullcalendar-custom/core/interactions/interaction' {
    import DateComponent from 'fullcalendar-custom/core/component/DateComponent';
...
declare module 'fullcalendar-custom/core/interactions/pointer' {
...
declare module 'fullcalendar-custom/core/interactions/hit' {
    import DateComponent from 'fullcalendar-custom/core/component/DateComponent';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { Rect } from 'fullcalendar-custom/core/util/geom';
...
declare module 'fullcalendar-custom/core/interactions/date-selecting' {
    import { Hit } from 'fullcalendar-custom/core/interactions/hit';
    export type dateSelectionJoinTransformer = (hit0: Hit, hit1: Hit) => any;
}

declare module 'fullcalendar-custom/core/interactions/event-dragging' {
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { EventMutation } from 'fullcalendar-custom/core/structs/event-mutation';
    import { Hit } from 'fullcalendar-custom/core/interactions/hit';
    import { EventDef } from 'fullcalendar-custom/core/structs/event';
    import { EventUi } from 'fullcalendar-custom/core/component/event-ui';
    import { View } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/core/interactions/event-resizing' {
    import { Hit } from 'fullcalendar-custom/core/interactions/hit';
    export type EventResizeJoinTransforms = (hit0: Hit, hit1: Hit) => false | object;
}

declare module 'fullcalendar-custom/core/interactions/ElementDragging' {
    import EmitterMixin from 'fullcalendar-custom/core/common/EmitterMixin';
...
declare module 'fullcalendar-custom/core/formatting-api' {
    import { DateInput } from 'fullcalendar-custom/core/datelib/env';
...
declare module 'fullcalendar-custom/core/options' {
    import { PluginDef } from 'fullcalendar-custom/core/plugin-system';
...
declare module 'fullcalendar-custom/core/structs/recurring-event' {
    import { EventInput, EventDef } from 'fullcalendar-custom/core/structs/event';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { DateEnv } from 'fullcalendar-custom/core/datelib/env';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
...
declare module 'fullcalendar-custom/core/structs/drag-meta' {
    import { Duration, DurationInput } from 'fullcalendar-custom/core/datelib/duration';
    import { EventNonDateInput } from 'fullcalendar-custom/core/structs/event';
...
declare module 'fullcalendar-custom/core/plugin-system' {
    import { reducerFunc } from 'fullcalendar-custom/core/reducers/types';
    import { eventDefParserFunc } from 'fullcalendar-custom/core/structs/event';
    import { eventDefMutationApplier } from 'fullcalendar-custom/core/structs/event-mutation';
    import Calendar, { DatePointTransform, DateSpanTransform, CalendarInteractionClass, OptionChangeHandlerMap } from 'fullcalendar-custom/core/Calendar';
    import { ViewConfigInputHash } from 'fullcalendar-custom/core/structs/view-config';
    import { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
    import { ViewProps } from 'fullcalendar-custom/core/View';
    import { CalendarComponentProps } from 'fullcalendar-custom/core/CalendarComponent';
    import { isPropsValidTester } from 'fullcalendar-custom/core/validation';
    import { eventDragMutationMassager, eventIsDraggableTransformer, EventDropTransformers } from 'fullcalendar-custom/core/interactions/event-dragging';
    import { dateSelectionJoinTransformer } from 'fullcalendar-custom/core/interactions/date-selecting';
    import { EventResizeJoinTransforms } from 'fullcalendar-custom/core/interactions/event-resizing';
    import { ExternalDefTransform } from 'fullcalendar-custom/core/interactions/external-element-dragging';
    import { InteractionClass } from 'fullcalendar-custom/core/interactions/interaction';
    import { ThemeClass } from 'fullcalendar-custom/core/theme/Theme';
    import { EventSourceDef } from 'fullcalendar-custom/core/structs/event-source';
    import { CmdFormatterFunc } from 'fullcalendar-custom/core/datelib/formatting-cmd';
    import { RecurringType } from 'fullcalendar-custom/core/structs/recurring-event';
    import { NamedTimeZoneImplClass } from 'fullcalendar-custom/core/datelib/timezone';
    import { ElementDraggingClass } from 'fullcalendar-custom/core/interactions/ElementDragging';
...
declare module 'fullcalendar-custom/core/reducers/types' {
    import { EventInput, EventInstanceHash } from 'fullcalendar-custom/core/structs/event';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventMutation } from 'fullcalendar-custom/core/structs/event-mutation';
    import { EventSource, EventSourceHash, EventSourceError } from 'fullcalendar-custom/core/structs/event-source';
    import { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { DateEnv } from 'fullcalendar-custom/core/datelib/env';
...
declare module 'fullcalendar-custom/core/CalendarComponent' {
    import Component, { ComponentContext } from 'fullcalendar-custom/core/component/Component';
    import { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
    import View from 'fullcalendar-custom/core/View';
    import Toolbar from 'fullcalendar-custom/core/Toolbar';
    import DateProfileGenerator, { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventUiHash } from 'fullcalendar-custom/core/component/event-ui';
    import { BusinessHoursInput } from 'fullcalendar-custom/core/structs/business-hours';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { CalendarState } from 'fullcalendar-custom/core/reducers/types';
...
declare module 'fullcalendar-custom/core/common/DayHeader' {
    import Component, { ComponentContext } from 'fullcalendar-custom/core/component/Component';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
...
declare module 'fullcalendar-custom/core/common/table-utils' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
...
declare module 'fullcalendar-custom/core/common/DaySeries' {
    import DateProfileGenerator from 'fullcalendar-custom/core/DateProfileGenerator';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
...
declare module 'fullcalendar-custom/core/interactions/event-interaction-state' {
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { Seg } from 'fullcalendar-custom/core/component/DateComponent';
...
declare module 'fullcalendar-custom/core/component/event-rendering' {
    import { EventDef, EventTuple, EventDefHash } from 'fullcalendar-custom/core/structs/event';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { Seg } from 'fullcalendar-custom/core/component/DateComponent';
    import { EventUi, EventUiHash } from 'fullcalendar-custom/core/component/event-ui';
    import { ComponentContext } from 'fullcalendar-custom/core/component/Component';
...
declare module 'fullcalendar-custom/core/common/DayTable' {
    import DaySeries from 'fullcalendar-custom/core/common/DaySeries';
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
    import { Seg } from 'fullcalendar-custom/core/component/DateComponent';
...
declare module 'fullcalendar-custom/core/common/slicing-utils' {
    import { DateRange } from 'fullcalendar-custom/core/datelib/date-range';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventUiHash } from 'fullcalendar-custom/core/component/event-ui';
    import { DateProfile } from 'fullcalendar-custom/core/DateProfileGenerator';
    import DateComponent, { Seg, EventSegUiInteractionState } from 'fullcalendar-custom/core/component/DateComponent';
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
...
declare module 'fullcalendar-custom/core/structs/event-mutation' {
    import { Duration } from 'fullcalendar-custom/core/datelib/duration';
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import { EventDef } from 'fullcalendar-custom/core/structs/event';
    import Calendar from 'fullcalendar-custom/core/Calendar';
...
declare module 'fullcalendar-custom/core/validation' {
    import { EventStore } from 'fullcalendar-custom/core/structs/event-store';
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { DateSpan, DateSpanApi } from 'fullcalendar-custom/core/structs/date-span';
    import EventApi from 'fullcalendar-custom/core/api/EventApi';
    import { EventInput } from 'fullcalendar-custom/core/structs/event';
    import { EventInteractionState } from 'fullcalendar-custom/core/interactions/event-interaction-state';
    import { SplittableProps } from 'fullcalendar-custom/core/component/event-splitting';
...
declare module 'fullcalendar-custom/core/api/EventApi' {
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { EventDef, EventInstance } from 'fullcalendar-custom/core/structs/event';
    import { EventMutation } from 'fullcalendar-custom/core/structs/event-mutation';
    import { DateInput } from 'fullcalendar-custom/core/datelib/env';
    import { DurationInput } from 'fullcalendar-custom/core/datelib/duration';
    import { FormatterInput } from 'fullcalendar-custom/core/datelib/formatting';
    import EventSourceApi from 'fullcalendar-custom/core/api/EventSourceApi';
...
declare module 'fullcalendar-custom/core/OptionsManager' {
...
declare module 'fullcalendar-custom/core/api/EventSourceApi' {
    import Calendar from 'fullcalendar-custom/core/Calendar';
    import { EventSource } from 'fullcalendar-custom/core/structs/event-source';
...
declare module 'fullcalendar-custom/core/structs/view-config' {
    import View from 'fullcalendar-custom/core/View';
    import { ViewSpec } from 'fullcalendar-custom/core/structs/view-spec';
...
declare module 'fullcalendar-custom/core/datelib/calendar-system' {
    import { DateMarker } from 'fullcalendar-custom/core/datelib/marker';
...
declare module 'fullcalendar-custom/core/datelib/formatting-cmd' {
    import { DateFormatter, DateFormattingContext, ZonedMarker, VerboseFormattingArg } from 'fullcalendar-custom/core/datelib/formatting';
...
declare module 'fullcalendar-custom/core/datelib/formatting-func' {
    import { DateFormatter, DateFormattingContext, ZonedMarker, VerboseFormattingArg } from 'fullcalendar-custom/core/datelib/formatting';
...
declare module 'fullcalendar-custom/core/event-sources/func-event-source' {
    import { EventSourceError } from 'fullcalendar-custom/core/structs/event-source';
    import { EventInput } from 'fullcalendar-custom/core/structs/event';
    ...
    const _default: import("fullcalendar-custom/core/plugin-system").PluginDef;
    export default _default;
}

declare module 'fullcalendar-custom/core/interactions/external-element-dragging' {
    import { DateSpan } from 'fullcalendar-custom/core/structs/date-span';
    import { DragMeta } from 'fullcalendar-custom/core/structs/drag-meta';
    export type ExternalDefTransform = (dateSpan: DateSpan, dragMeta: DragMeta) => any;
}

declare module 'fullcalendar-custom/core/Toolbar' {
    import Component from 'fullcalendar-custom/core/component/Component';
