...
declare module 'fullcalendar-custom/interaction' {
    import FeaturefulElementDragging from 'fullcalendar-custom/interaction/dnd/FeaturefulElementDragging';
    const _default: import("fullcalendar-custom/core").PluginDef;
    export default _default;
    export { FeaturefulElementDragging };
    export { default as PointerDragging } from 'fullcalendar-custom/interaction/dnd/PointerDragging';
    export { default as Draggable } from 'fullcalendar-custom/interaction/interactions-external/ExternalDraggable';
    export { default as ThirdPartyDraggable } from 'fullcalendar-custom/interaction/interactions-external/ThirdPartyDraggable';
}

declare module 'fullcalendar-custom/interaction/dnd/FeaturefulElementDragging' {
    import { PointerDragEvent, ElementDragging } from 'fullcalendar-custom/core';
    import PointerDragging from 'fullcalendar-custom/interaction/dnd/PointerDragging';
    import ElementMirror from 'fullcalendar-custom/interaction/dnd/ElementMirror';
    import AutoScroller from 'fullcalendar-custom/interaction/dnd/AutoScroller';
...
declare module 'fullcalendar-custom/interaction/dnd/PointerDragging' {
    import { EmitterMixin, PointerDragEvent } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/interaction/interactions-external/ExternalDraggable' {
    import { PointerDragEvent } from 'fullcalendar-custom/core';
    import FeaturefulElementDragging from 'fullcalendar-custom/interaction/dnd/FeaturefulElementDragging';
    import { DragMetaGenerator } from 'fullcalendar-custom/interaction/interactions-external/ExternalElementDragging';
...
declare module 'fullcalendar-custom/interaction/interactions-external/ThirdPartyDraggable' {
    import { DragMetaGenerator } from 'fullcalendar-custom/interaction/interactions-external/ExternalElementDragging';
    import InferredElementDragging from 'fullcalendar-custom/interaction/interactions-external/InferredElementDragging';
...
declare module 'fullcalendar-custom/interaction/dnd/ElementMirror' {
    import { Rect } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/interaction/dnd/AutoScroller' {
    import { ScrollGeomCache } from 'fullcalendar-custom/interaction/scroll-geom-cache';
...
declare module 'fullcalendar-custom/interaction/interactions-external/ExternalElementDragging' {
    import { Hit, PointerDragEvent, EventTuple, DatePointApi, Calendar, EventInteractionState, DragMetaInput, DragMeta, View, ElementDragging } from 'fullcalendar-custom/core';
    import HitDragging from 'fullcalendar-custom/interaction/interactions/HitDragging';
...
declare module 'fullcalendar-custom/interaction/interactions-external/InferredElementDragging' {
    import { PointerDragEvent, ElementDragging } from 'fullcalendar-custom/core';
    import PointerDragging from 'fullcalendar-custom/interaction/dnd/PointerDragging';
...
declare module 'fullcalendar-custom/interaction/scroll-geom-cache' {
    import { Rect, ScrollController } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/interaction/interactions/HitDragging' {
    import { EmitterMixin, PointerDragEvent, Point, Hit, InteractionSettingsStore, ElementDragging } from 'fullcalendar-custom/core';
    import OffsetTracker from 'fullcalendar-custom/interaction/OffsetTracker';
...
declare module 'fullcalendar-custom/interaction/OffsetTracker' {
    import { Rect } from 'fullcalendar-custom/core';
    import { ElementScrollGeomCache } from 'fullcalendar-custom/interaction/scroll-geom-cache';
