...
declare module 'fullcalendar-custom/daygrid' {
    export { default as SimpleDayGrid, DayGridSlicer } from 'fullcalendar-custom/daygrid/SimpleDayGrid';
    export { default as DayGrid, DayGridSeg } from 'fullcalendar-custom/daygrid/DayGrid';
    export { default as AbstractDayGridView } from 'fullcalendar-custom/daygrid/AbstractDayGridView';
    export { default as DayGridView, buildDayTable as buildBasicDayTable } from 'fullcalendar-custom/daygrid/DayGridView';
    export { default as DayBgRow } from 'fullcalendar-custom/daygrid/DayBgRow';
    const _default: import("fullcalendar-custom/core").PluginDef;
    export default _default;
}

declare module 'fullcalendar-custom/daygrid/SimpleDayGrid' {
    import { DateProfile, EventStore, EventUiHash, DateSpan, EventInteractionState, DayTable, Duration, DateComponent, DateRange, Slicer, Hit, ComponentContext } from 'fullcalendar-custom/core';
    import { default as DayGrid, DayGridSeg } from 'fullcalendar-custom/daygrid/DayGrid';
...
declare module 'fullcalendar-custom/daygrid/DayGrid' {
    import { PositionCache, DateMarker, DateComponent, EventSegUiInteractionState, Seg, DateProfile, ComponentContext } from 'fullcalendar-custom/core';
    import Popover from 'fullcalendar-custom/daygrid/Popover';
    import DayGridEventRenderer from 'fullcalendar-custom/daygrid/DayGridEventRenderer';
    import DayTile from 'fullcalendar-custom/daygrid/DayTile';
...
declare module 'fullcalendar-custom/daygrid/AbstractDayGridView' {
    import { ScrollComponent, View, Duration, ComponentContext, ViewProps } from 'fullcalendar-custom/core';
    import DayGrid from 'fullcalendar-custom/daygrid/DayGrid';
...
declare module 'fullcalendar-custom/daygrid/DayGridView' {
    import { DayHeader, ComponentContext, DateProfileGenerator, DateProfile, ViewProps, DayTable } from 'fullcalendar-custom/core';
    import AbstractDayGridView from 'fullcalendar-custom/daygrid/AbstractDayGridView';
    import SimpleDayGrid from 'fullcalendar-custom/daygrid/SimpleDayGrid';
...
declare module 'fullcalendar-custom/daygrid/DayBgRow' {
    import { ComponentContext, DateMarker, DateProfile } from 'fullcalendar-custom/core';
...
declare module 'fullcalendar-custom/daygrid/Popover' {
...
declare module 'fullcalendar-custom/daygrid/DayGridEventRenderer' {
    import { Seg } from 'fullcalendar-custom/core';
    import DayGrid from 'fullcalendar-custom/daygrid/DayGrid';
    import SimpleDayGridEventRenderer from 'fullcalendar-custom/daygrid/SimpleDayGridEventRenderer';
...
declare module 'fullcalendar-custom/daygrid/DayTile' {
    import { DateComponent, Seg, Hit, DateMarker, ComponentContext, EventInstanceHash } from 'fullcalendar-custom/core';
    import SimpleDayGridEventRenderer from 'fullcalendar-custom/daygrid/SimpleDayGridEventRenderer';
...
declare module 'fullcalendar-custom/daygrid/SimpleDayGridEventRenderer' {
    import { FgEventRenderer, Seg } from "fullcalendar-custom/core";
